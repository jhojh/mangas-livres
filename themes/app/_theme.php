...
<head>
    ...
    <link rel="stylesheet" href="<?= url("themes/app/assets/css/_themes.css"); ?>">
...
<header>
       ...
       <div class="header-logo">
           <img src="<?= url("themes/app/assets/images/Logo Mangás Livre.svg"); ?>" alt="Mangás Logo" onclick="window.location.href='<?=url("/");?>'">
       </div>
       ...
       <div class="search">
           ...
           <div class="nav-list">
               <ul>
                   ...
                   <li onclick="window.location.href='<?=url("/app/perfil");?>'"><i class="fa-regular fa-user" style="color: #ffffff;"></i></li>
               </ul>
            ...
            <div class="footer-container">
                <div class="footer-content">
                    <div class="footer-logo">
                        <img src="<?= url("themes/app/assets/images/Logo Mangás Livre (1).svg"); ?>" alt="Logo">
                    </div>
                    <div class="">
